...
import DeletingWarehouse from "../components/DeletingWarehouse";
    ...
    <div className="warehouse-list-page">
      ...
      <div className="fullscreen-labels">
        <div className="warehouse-label label--fullscreen">
          ...
          <img
            className="warehouse-label__icon"
            src={sort}
            alt="sort-icon"
          ></img>
        </div>
        ...
        <div className="contact-info-label label--fullscreen">
          ...
          <img
            className="contact-info-label__icon"
            src={sort}
            alt="sort-icon"
          ></img>
        </div>
